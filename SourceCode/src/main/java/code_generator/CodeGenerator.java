...
public class CodeGenerator {
    ...
    public final Map< ClassNameToken, VTable> vtables;
    ...
    public CodeGenerator(final Program program,
        ...
        vtables = new HashMap< ClassNameToken, VTable>();
        for (final  ClassNameToken className : classes.keySet()) {
            makeVTableForClass(className);
        }
    }

    public static FunctionName nameMangleFunctionName(final  ClassNameToken className,
                                                      final MethodName methodName) {
        return new FunctionName(className.name + "_" + methodName.name);
    }

    public static FunctionName nameMangleConstructorName(final  ClassNameToken className) {
        return new FunctionName(className.name + "_constructor");
    }
    
    private VTable makeVTableForClass(final  ClassNameToken className) throws TypeErrorException {
    ...
    public VTable getVTable(final  ClassNameToken className) {
    ...
    public Set<Variable> writeAssignStmt(final AssignmentStmt stmt,
                                         final Set<Variable> localVariables)
        throws CodeGeneratorException, IOException {
        writeVariable(stmt.var, localVariables);
        output.print(" = ");
        writeExp(stmt.exp, localVariables);
        output.println(";");
        return localVariables;
    ...
    public Set<Variable> writeStmt(final Stmt stmt,
        ...
        if (stmt instanceof ExpStmt) {
            ...
            return writeAssignStmt((AssignmentStmt)stmt, localVariables);
    ...
    public void writeMethod(final  ClassNameToken forClass,
