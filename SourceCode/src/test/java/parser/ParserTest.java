...
public class ParserTest {
    ...
    public void testVarDec() throws ParseException {
        ...
        assertEquals(
                new ParseResult<Stmt>(
                        new VarDecStmt(new VarDec(new TypeToken("Int"), new Variable("x")), new IntLiteralExp(0)),
                        0),
    ...
    public void testSecondaryLength() throws ParseException {
        final Parser parser = new Parser(Arrays.asList(new LengthToken(), new LeftParenToken(), new Variable("f"),
    ...
    public void testIfToken() throws ParseException {
        ...
        final Parser parser = new Parser(Arrays.asList(
                new IfToken(), new LeftParenToken(), new IntLiteralToken(0), new RightParenToken(), new ReturnToken(),
    ...
    public void testWhileToken() throws ParseException {
        ...
        // while (0) break;
        final Parser parser = new Parser(Arrays.asList(
                new WhileToken(), new LeftParenToken(), new IntLiteralToken(0), new RightParenToken(), new BreakToken(),
                new SemicolonToken()));
    ...
    public void testArrayAssignment() throws ParseException {
        ...
        // var[exp] = exp;
        final Parser parser = new Parser(Arrays.asList(
                new Variable("f"), new LeftBracketToken(), new IntLiteralToken(0), new RightBracketToken(),
    ...
    public void testClassDef() throws ParseException {
        ...
        new ClassToken(), new ClassName("test"), new ExtendsToken(), new ClassName("bob"),
        new LeftCurlyToken(), new InstanceDecToken(instanceDec), new ClassName("test"), new LeftParenToken(), varDec,
